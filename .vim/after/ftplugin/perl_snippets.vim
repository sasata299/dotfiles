...
exec "Snippet cont sub ".st."func".et." : ".st."Attribute".et." {<CR>my ($self, $c) = @_;<CR>".st.et."<CR>}<CR>".st.et
...
exec "Snippet det $c->detach('".st."name".et."');<CR>".st.et
exec "Snippet forw $c->forward('".st."name".et."');<CR>".st.et
exec "Snippet conf $c->config->{".st."name".et."}".st.et
exec "Snippet stash $c->stash->{".st."var".et."} = ".st.et.";<CR>".st.et
exec "Snippet fla $c->flash->{".st."var".et."} = ".st.et.";<CR>".st.et
exec "Snippet sess $c->session->{".st."var".et."} = ".st.et.";<CR>".st.et
exec "Snippet rs $c->model('DBIC::".st."Source".et."')".st.et
exec "Snippet redi $c->res->redirect($c->uri_for('".st."uri".et."'));<CR>".st.et
exec "Snippet para $c->req->param('".st."param".et."')".st.et
exec "Snippet paras $c->req->params;".st.et
